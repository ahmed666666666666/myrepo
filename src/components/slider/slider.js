    ...
    return(
        <div className="main-div">
            ...
            <div className="center-div" id="centerdiv">
               {movie.map(val=> <div className="c"><Mcard movie={val}  url="https://occ-0-4609-784.1.nflxso.net/dnm/api/v6/X194eJsgWBDE2aQbaNdmCXGUP-Y/AAAABdxTC0_BQ1EG1Z7dw8m0kqy33fyfKZOg-samS-5nW7o7LaDZb-0Nxl7dePzGdV46ZLV1nHmDX5RMKnPQO7al1YgqSbY.webp?r=538"  /></div>)}
